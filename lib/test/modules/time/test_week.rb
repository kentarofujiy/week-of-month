...
class TestWeekForTime < Test::Unit::TestCase
  ...
  def test_nextweek
    assert_equal Time.new(2012, 12, 8), Time.new(2012, 12, 1).nextweek
    assert_equal Time.new(2012, 12, 22), Time.new(2012, 12, 15).nextweek
    assert_equal Time.new(2013, 1, 5), Time.new(2012, 12, 29).nextweek
    assert_equal Time.new(2012, 12, 26), Time.new(2012, 12, 19).nextweek
  end
