...
class TestWeekForDate < Test::Unit::TestCase
  ...
  def test_nextweek
    assert_equal Date.new(2012, 12, 8), Date.new(2012, 12, 1).nextweek
    assert_equal Date.new(2012, 12, 22), Date.new(2012, 12, 15).nextweek
    assert_equal Date.new(2013, 1, 5), Date.new(2012, 12, 29).nextweek
    assert_equal Date.new(2012, 12, 26), Date.new(2012, 12, 19).nextweek
  end
